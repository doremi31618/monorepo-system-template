---
name: design
description: 'Comprehensive design routing for product interaction design, brand identity, design tokens, UI styling, logos, corporate identity programs, presentations, banners, icons, and social media assets. Use for UI/UX flows including search, filter, sort, data tables, and query builders; route interaction decisions to ui-ux-pro-max and framework implementation to the matching component skill.'
...
- Product interaction design, including search, filter, sort, and data views
...
| ---------------------------------------- | ------------------------ | -------------------------------------------- |
| Product flows, search, filter, sort      | `ui-ux-pro-max`          | Interaction model and data-view contract     |
| Svelte and shadcn-svelte implementation | `shadcn-svelte`          | Accessible Svelte component composition      |
| React shadcn/ui, Tailwind, visual polish | `ui-styling`             | React components and styling                 |
...
3. **Implement** → Use shadcn-svelte for Svelte projects or ui-styling for React projects
...
**External sub-skills:** brand, design-system, ui-ux-pro-max, shadcn-svelte, ui-styling
