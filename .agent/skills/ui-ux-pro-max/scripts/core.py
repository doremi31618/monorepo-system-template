...
def detect_domain(query):
    ...
    domain_keywords = {
        ...
        "ux": ["ux", "usability", "accessibility", "wcag", "touch", "scroll", "animation", "keyboard", "navigation", "mobile", "search", "filter", "sort", "query builder", "table toolbar", "data table", "popover", "combobox", "pagination", "button", "action width", "full width", "stretch", "icon", "icon first", "icon-first", "icon led", "icon-led", "icon only", "too much text", "information hierarchy", "visual hierarchy", "duplicate information", "entity header", "detail page", "action locality"],
