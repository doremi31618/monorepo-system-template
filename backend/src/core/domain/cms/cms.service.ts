...
import { assets } from '../assets/assets.schema.js';
...
export class CmsService {
    ...
    async listPosts(page = 1, limit = 10, locale = 'en', options: ListPostsOptions = {}) {
    ...
    async listPublicPosts(page = 1, limit = 10, locale = 'en', options: ListPublicPostsOptions = {}) {
        const offset = (page - 1) * limit;
        const normalizedQuery = options.query?.trim();
    ...
    async getPublicHome(locale = 'en', latestLimit = 6, hotTagLimit = 4, hotPostPerTag = 3) {
