import { pgTable, uuid, varchar, text, timestamp, jsonb, primaryKey, integer, date } from 'drizzle-orm/pg-core';
...
export const postTags = pgTable('post_tags', {
    ...
    tagId: uuid('tag_id').references(() => cmsTags.id, { onDelete: 'cascade' }).notNull(),
    createdAt: timestamp('created_at').defaultNow().notNull(),
}, (t) => ({
